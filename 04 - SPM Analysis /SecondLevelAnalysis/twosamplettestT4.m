...
second_level_dir = fullfile(base_dir, 'second_level', 't4_rTMS_vs_placebo');
ses_name = 'ses-T4';  % Jetzt T4 statt T1
...
for i = 1:length(rTMS_IDs)
    ...
    sub_path = fullfile(base_dir, ['sub-' id_clean], ses_name, 'FL_ALL_MASK', contrast_file);
    if isfile(sub_path)
